...
public final  class rwdpromptmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm062( )
   {
      ...
      httpContext.AddJavascriptSource("rwdpromptmasterpage.js", "?20212261156253", false, true);
   ...
   public void wb060( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         com.identityprovider.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "PromptMainTable", "left", "top", "", "", "div");
         /* Div Control */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?202122611562512", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("rwdpromptmasterpage.js", "?202122611562512", false, true);
      }
